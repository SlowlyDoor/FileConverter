...
public class ConvertJsonToXml {
    public void Convert(String json, String xml) throws FileNotFoundException, JAXBException {
        Mangalib mangalib = ReadJson(json);
        WriteXml(xml, mangalib);
    }

    private void WriteXml(String path, Mangalib mangalib) throws JAXBException {
    ...
    private Mangalib ReadJson(String path) throws FileNotFoundException {
